...
def cv_kfold_random_sampling(n_population, kfold=9, seed=999):
    ...
    fold_sizes = (n_population // kfold) * np.ones(kfold, dtype=int)  # other folds
...
def cv_kfold_systematic_sampling(n_population, kfold=9):
    ...
    fold_sizes = ((n_population // kfold) + 1 ) * np.ones(kfold, dtype=int)
...
def cv_lpo_random_sampling(n_population, p=3, seed=999):
    ...
    if mod == 0:
        ...
        fold_sizes = p * np.ones(kfold, dtype=int)
    else:
